...
const VIDEOS = {
    "1": "SampleVideo_1280x720_1mb.mp4",
    "2": "ScreamingBeaverMeme.mp4"
}; // have constant of video lists, normally we'll use DB but this is alright
...
async function main() {
	...
	function broadcastViewedMessage(messageChannel, videoId) {
	    ...
	    const msg = { 
            videoPath: VIDEOS[videoId], // getting the video name
            videoId: videoId
        };
    ...
    app.get("/video", async (req, res) => { // Route for streaming video.
        ...
        const videoPath = `./videos/${VIDEOS[req.query.id]}`;
        ...
        broadcastViewedMessage(messageChannel, req.query.id); // Sends the "viewed" message to indicate this video has been watched.
    });
